...
wget https://github.com/ethcore/parity-snappy/releases/download/v1.1.0-dev-unstable.4/parity-arm-v1.1.0-dev-unstable.4.tar.gz
tar -xvf parity-arm-v1.1.0-dev-unstable.4.tar.gz parity-arm
echo "check file"
file parity-arm
